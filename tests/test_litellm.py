...
STANDARD_MODEL_TESTS = [
    ...
    ('vertex_ai/gemini-1.5-flash', None, 'gemini-1.5-flash',
     {
    ...
    ('openai/Qwen/Qwen2.5-72B-Instruct', 'NEBIUS_API_KEY', 'Qwen/Qwen2.5-72B-Instruct',
     {'api_base': 'https://api.studio.nebius.ai/v1', 'custom_llm_provider ': 'nebius'}),
    ('together_ai/Qwen/Qwen2.5-7B-Instruct-Turbo', 'TOGETHER_AI_API_KEY', 'together_ai/Qwen/Qwen2.5-7B-Instruct-Turbo',
     None),
    (
    'together_ai/Qwen/Qwen2.5-72B-Instruct-Turbo', 'TOGETHER_AI_API_KEY', 'together_ai/Qwen/Qwen2.5-72B-Instruct-Turbo',
    None),
]
